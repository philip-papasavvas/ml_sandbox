...
* notebook-projects
  ...
  * Natural Language Processing on SMS messages: using different machine learning models (Logistic Regression) and feature engineering, tokenization and normalisation. This dataset was taken from [Kaggle](https://www.kaggle.com/uciml/sms-spam-collection-dataset), and is also found on the **SMS spam** dataset from [UCI Machine learning](https://archive.ics.uci.edu/ml/datasets/sms+spam+collection)
